...
public interface ThreadEnforcer {
    ...
    ThreadEnforcer ANY = new ThreadEnforcer() {
        @Override
        public void enforce(KQBus bus) {
            // Allow any thread.
        }
    };

    /**
     * A {@link ThreadEnforcer} that confines {@link Bus} methods to the main
     * thread.
     */
